...
class Collision :public GenericFrequentEntities
{
public:
    /*----< 2D >----*/
   //--円同士の当たり判定--//
   ...
   //--球と球の交差判定--//
    ...
    //--視錐台と直方体の交差判定--//
    static bool frustum_vs_cuboid(DirectX::XMFLOAT4X4 camara_view, DirectX::XMFLOAT4X4 camara_proj, const DirectX::XMFLOAT3& cuboid_min_pos, const DirectX::XMFLOAT3& cuboid_max_pos);
    static bool forefront_frustum_vs_cuboid(DirectX::XMFLOAT4X4 camara_view,float camera_range, const DirectX::XMFLOAT3& cuboid_min_pos, const DirectX::XMFLOAT3& cuboid_max_pos); // プレイヤーとカメラの間の視錐台
    //--球とカプセルの交差判定--//
