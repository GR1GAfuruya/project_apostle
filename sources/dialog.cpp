...
//static wchar_t w_pathBuffer[MAX_PATH];
//
...
//}
//
//DialogResult Dialog::OpenFileName(TCHAR* filepath, int size, const char* filter, const char* title, HWND hWnd, bool multiSelect)
//{
//	//// 初期パス設定
...
//	//{
//	//	// ディレクトリパス取得
//	//	::_wsplitpath_s(filepath, nullptr, 0, dirname, MAX_PATH, nullptr, 0, nullptr, 0);
//	//}
//	//else
//	//{
//	//	filepath[0] = dirname[0] = '\0';
...
//	//if ((dirname[0] == '\0'))
//	//{
//	//	wcscpy_s(dirname, MAX_PATH, w_pathBuffer);
//	//}
//	//// lpstrInitialDir は \ でないと受け付けない
//	//for (wchar_t* p = dirname; *p != '\0'; p++)
//	//{
//	//	if (*p == '/')
//	//		*p = '\\';
//	//}
...
//
//	//// 最終パスを記憶
//	//wcscpy_s(w_pathBuffer, MAX_PATH, filepath);
//
//	return DialogResult::OK;
//}
//
