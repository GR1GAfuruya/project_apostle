...
#include "user.h"
#include "texture.h"
SpriteEmitter::SpriteEmitter(Graphics& graphics, int max_particles)
...
void SpriteEmitter::emit(Graphics& graphics, float elapsed_time)
{
	//エミット処理
...
void SpriteEmitter::update(Graphics& graphics, float elapsed_time)
{
	//パーティクルの更新
...
void SpriteEmitter::render(Graphics& graphics, Camera& camera)
{
...
void SpriteEmitter::debug_gui(Graphics& graphics, string id)
{
