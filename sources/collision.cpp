...
bool Collision::cuboid_vs_cuboid(const DirectX::XMFLOAT3& center_a, const DirectX::XMFLOAT3& radius_a, const DirectX::XMFLOAT3& center_b, const DirectX::XMFLOAT3& radius_b, DirectX::XMFLOAT3* velocity_b)
{
    using namespace DirectX;
...
bool Collision::frustum_vs_cuboid(DirectX::XMFLOAT4X4 camara_view, DirectX::XMFLOAT4X4 camara_proj,const DirectX::XMFLOAT3& cuboid_min_pos, const DirectX::XMFLOAT3& cuboid_max_pos)
{
    using namespace DirectX;
    //----- 直方体のパラメーター -----//
...
bool Collision::forefront_frustum_vs_cuboid(DirectX::XMFLOAT4X4 camara_view, float camera_range, const DirectX::XMFLOAT3& cuboid_min_pos, const DirectX::XMFLOAT3& cuboid_max_pos)
{
    using namespace DirectX;
    //----- 直方体のパラメーター -----//
    XMFLOAT3 cuboid_radius = { (cuboid_max_pos.x - cuboid_min_pos.x) / 2, (cuboid_max_pos.y - cuboid_min_pos.y) / 2, (cuboid_max_pos.z - cuboid_min_pos.z) / 2 };
...
bool Collision::sphere_vs_capsule(const DirectX::XMFLOAT3& sphere_center, float sphere_radius, const DirectX::XMFLOAT3& capsule_start, const DirectX::XMFLOAT3& capsule_end, float capsule_radius)
{
    using namespace DirectX;
...
bool Collision::capsule_vs_capsule(const DirectX::XMFLOAT3& start_a, const DirectX::XMFLOAT3& end_a, float radius_a, const DirectX::XMFLOAT3& start_b, const DirectX::XMFLOAT3& end_b, float radius_b)
{
    using namespace DirectX;
